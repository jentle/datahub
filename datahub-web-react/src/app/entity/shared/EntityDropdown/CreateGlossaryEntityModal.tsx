...
function CreateGlossaryEntityModal(props: Props) {
    ...
    return (
        <Modal
            title={`${t('Create')} ${entityRegistry.getEntityName(entityType)}`}
            visible
            onCancel={onClose}
            footer={
                <>
        ...
        >
            ...
            >
                ...
                <Form.Item
                    label={
                        <Typography.Text strong>
                            {t('Parent')} <OptionalWrapper>({t('optional')})</OptionalWrapper>
                        </Typography.Text>
                    }
                >
                ...
                <StyledItem
                    label={
                        <Typography.Text strong>
                            {t('Documentation')} <OptionalWrapper>({t('optional')})</OptionalWrapper>
                        </Typography.Text>
                    }
                >
                    <StyledButton type="link" onClick={() => setIsDocumentationModalVisible(true)}>
                        <EditOutlined />
                        {documentation ? 'Edit' : 'Add'} {t('Documentation')}
                    </StyledButton>
