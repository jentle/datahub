...
export default function TableStats({
    ...
    return (
        <StatSection>
            <Typography.Title level={5}>{t('Table Stats')}</Typography.Title>
            <StatContainer justifyContent={justifyContent}>
                {rowCount && (
                    <InfoItem title={t('Rows')}>
                ...
                {queryCount && (
                    <InfoItem title={t('Monthly Queries')}>
                        <Typography.Text strong style={{ fontSize: 24 }}>
                            {queryCount}
                        </Typography.Text>
                    </InfoItem>
                ...
                {lastUpdatedTime && (
                    <InfoItem title={t('Last Updated')} width="220px">
