...
export const LinkModal = (props: LinkModalProps) => {
    ...
    return (
        <Modal title={t('Add Link')} okText={t('Save')} onCancel={handleClose} onOk={handleOk} visible={visible}>
            <Form
                form={form}
                layout="vertical"
                colon={false}
            ...
            >
                <Form.Item
                    name="href"
                    label={<Typography.Text strong>{t('Link URL')}</Typography.Text>}
                    rules={[{ required: true }]}
                >
                    <Input placeholder={t('https://www.google.com')} autoFocus />
                </Form.Item>
                <Form.Item name="text" label={<Typography.Text strong>{t('Text')}</Typography.Text>}>
                    <Input />
                </Form.Item>
            </Form>
        </Modal>
