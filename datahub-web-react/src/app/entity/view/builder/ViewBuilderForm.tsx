    ...
    return (
        <span data-testid="view-builder-form">
            <Form form={form} initialValues={state} layout="vertical">
                ...
                <StyledFormItem
                    label={<Typography.Text strong>{t('Filters')}</Typography.Text>}
                    style={{ marginBottom: 8 }}
                >
                    <Typography.Paragraph>
                        {t(
                            'Select the filters that are applied when this View is selected. Assets that match these filters will be shown when the View is applied.',
                        )}
                    </Typography.Paragraph>
                </StyledFormItem>
            </Form>
