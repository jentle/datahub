...
export const EditOwnersModal = ({
    ...
    return (
        <Modal
            title={t(title || `${operationType === OperationType.ADD ? 'Add' : 'Remove'} Owners`)}
            visible
        ...
        >
            <Form layout="vertical" colon={false}>
                <Form.Item key="owners" name="owners" label={<Typography.Text strong>{t('Owner')}</Typography.Text>}>
                    <Typography.Paragraph>{t('Find a user or group')}</Typography.Paragraph>
                    <Form.Item name="owner">
                        <SelectInput
                            ...
                            mode="multiple"
                            ref={inputEl}
                            placeholder={t('Search for users or groups...')}
                            showSearch
                            filterOption={false}
                ...
                {!hideOwnerType && (
                    <Form.Item label={<Typography.Text strong>{t('Type')}</Typography.Text>}>
                        <Typography.Paragraph>{t('Choose an owner type')}</Typography.Paragraph>
                        <Form.Item name="type">
                            {loading && <Select />}
                            {!loading && (
                                    ...
                                    {ownershipTypes.map((ownershipType: OwnershipTypeEntity | undefined) => {
                                        ...
                                        return (
                                            <Select.Option key={ownershipTypeUrn} value={ownershipTypeUrn}>
                                                <Typography.Text>{t(ownershipTypeName)}</Typography.Text>
                                                <Typography.Paragraph
                                                    style={{ wordWrap: 'break-word', whiteSpace: 'break-spaces' }}
                                                    type="secondary"
                                                >
                                                    {t(ownershipTypeDescription)}
                                                </Typography.Paragraph>
                                            </Select.Option>
                                        );
                                    })}
