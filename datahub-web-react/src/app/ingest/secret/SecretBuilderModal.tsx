            ...
            >
                <Form.Item label={<Typography.Text strong>Name</Typography.Text>}>
                    ...
                    <Form.Item
                        ...
                        hasFeedback
                    >
                        <Input placeholder={t('A name for your secret')} />
                    </Form.Item>
                </Form.Item>
                <Form.Item label={<Typography.Text strong>Value</Typography.Text>}>
                    ...
                    <Form.Item
                        ...
                        hasFeedback
                    >
                        <Input.TextArea placeholder={t('The value of your secret')} autoComplete="false" />
                    </Form.Item>
                </Form.Item>
                <Form.Item label={<Typography.Text strong>Description</Typography.Text>}>
                    ...
                    <Form.Item
                        ...
                        hasFeedback
                    >
                        <Input.TextArea placeholder={t('A description for your secret')} />
                    </Form.Item>
                </Form.Item>
            </Form>
        </Modal>
