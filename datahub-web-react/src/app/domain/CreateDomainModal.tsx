        ...
        >
            ...
            >
                <Form.Item label={<Typography.Text strong>{t('Name')}</Typography.Text>}>
                    <Typography.Paragraph>{t('Domain.create.name.description')}</Typography.Paragraph>
                    <Form.Item
                        ...
                        hasFeedback
                    >
                        <Input data-testid="create-domain-name" placeholder={T('A name for your domain')} />
                    </Form.Item>
                    <SuggestedNamesGroup>
                ...
                <Form.Item label={<Typography.Text strong>{t('Description')}</Typography.Text>}>
                    <Typography.Paragraph>{t('Domain.create.description')}</Typography.Paragraph>
                    <Form.Item
                        name={DESCRIPTION_FIELD_NAME}
                        rules={[{ whitespace: true }, { min: 1, max: 500 }]}
                        hasFeedback
                    >
                        <Input.TextArea placeholder={t('A description for your domain')} />
                    </Form.Item>
                </Form.Item>
                <Collapse ghost>
                    <Collapse.Panel
                        ...
                        key="1"
                    >
                        <Form.Item label={<Typography.Text strong>{t('Domain Id')}</Typography.Text>}>
                            <Typography.Paragraph>{t('Domain.create.id.description')}</Typography.Paragraph>
                            <Form.Item
                                name={ID_FIELD_NAME}
                                rules={[
                                    () => ({
                            ...
                            >
                                <Input data-testid="create-domain-id" placeholder={t('engineering')} />
                            </Form.Item>
                        </Form.Item>
                    </Collapse.Panel>
                </Collapse>
